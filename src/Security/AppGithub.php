...
class AppGithub extends SocialAuthenticator implements LogoutSuccessHandlerInterface
{
    ...
    private $loginroute ;
        function __construct(RouterInterface $router ,ClientRegistry $clientRegistry ,UtilisateurRepository $utilisateurRepository){
$this->router=$router ;
...
$this->utilisateurRepository = $utilisateurRepository ;
    ...
    {/** @var GithubResourceOwner $user */
       ...
       return $this->utilisateurRepository->findOrCreateFromGithubOauth($user);
    }
